...
func TestJWT(t *testing.T) {
	...
	// 生成access token
	accessToken, err := user_utils.GenerateAccessToken(jwtConf, uuid)
	if err != nil {
	...
	// 验证token
	var parseToken *user_utils.Claim
	parseToken, err = user_utils.ParseToken(accessToken, jwtConf)
	if err != nil {
...
func TestExpiredToken(t *testing.T) {
	...
	// 解析验证token
	_, err = user_utils.ParseToken(accessToken, jwtConf)
	if err == nil {
...
func TestHijackToken(t *testing.T) {
	...
	// 解析验证token
	_, err = user_utils.ParseToken(tamperedToken, jwtConf)
	if err == nil {
